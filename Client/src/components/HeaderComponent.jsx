    ...
    <div>
        <header>
            <nav className='navbar navbar-dark bg-dark'>
                <a className="navbar-brand" href="/"><h1 style={{ display: "inline", margin: "0", marginRight: "20px", fontSize: "24px" }}>HealthyMate</h1></a>
                <a className="navbar-brand" href="/meallist"><h6 style={{ display: "inline", margin: "0", marginRight: "10px", fontSize: "14px", color: "#fff" }}>All Meal Plans</h6></a>
