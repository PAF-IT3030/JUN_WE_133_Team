                                ...
                                <form encType='multipart/form-data'>
                                    <div className="form-group">
                                        ...
                                        <input placeholder="Fitness Activity" name="fitnessActivity" className="form-control" 
                                            value={this.state.fitness_act} onChange={this.changefitness_actHandler}/>
                                    </div>
                                    <div className="form-group">
                                        <label> Workouts: </label>
                                        <input placeholder="Workouts" name="workouts" className="form-control" 
                                            value={this.state.workouts} onChange={this.changeworkoutsHandler}/>
                                    </div>
                                    <div className="form-group">
                                        <label> Meals: </label>
                                        <input placeholder="Meals" name="meals" className="form-control" 
                                            value={this.state.meals} onChange={this.changemealsHandler}/>
                                    </div>
                                    <div className="form-group">
